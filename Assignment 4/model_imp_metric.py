...
class Sentimentmodel(object):
    def __init__(self, args):
        ...
        if args.bidirect:
            self.model = BiLSTMModel(args.model, self.ntokens, args.emb_size, args.hidden_size, args.nlayers,
                                     args.dropout,
                                     args.bidirect, nlabels=self.nlabels).to(self.device)
        else:
            self.model = UniLSTMModel(args.model, self.ntokens, args.emb_size, args.hidden_size, args.nlayers,
                                      args.dropout,
                                      args.bidirect, nlabels=self.nlabels).to(self.device)
