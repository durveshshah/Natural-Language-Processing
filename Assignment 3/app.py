...
def getgenerate():
    ...
    doc = model_api.generate(int(max_len))
    # YOUR CODE ENDS HERE
    #######################
...
def getrecommend():
    ...
    #######################
    # YOUR CODE STARTS HERE
    Top_k_len = request.args.get('topk',type = int)
    Context_words = request.args.get('context')
    rec_toks = model_api.recommend(Context_words, Top_k_len)
    # YOUR CODE ENDS HERE
    #######################
